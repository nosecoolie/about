            ...
            <div className='card'>
                ...
                <div style={{ paddingTop: '56px', textAlign: 'center' }}>
                    ...
                    <p style={{fontSize: '1˙px', lineHeight: '1.3', color: '#666', textAlign: 'justify'}}>
                        ...
                        或是你偏好直接先看我的履歷，我也準備了 PDF 的版本。<a href='' target='_blank' style={{color: '#2196F3'}}>在這裡。</a>
                    </p>
                    <a href='' target='_blank' className='skill-tag' style={{height: '36px', lineHeight: '36px', padding: '0 20px', backgroundColor: '#2196F3', fontSize: '16px', cursor: 'pointer'}} >我的履歷</a>
                </div>
            </div>
        )
    }
